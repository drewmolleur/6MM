...
public class Board extends JPanel {
	...
	Point getPositionCoords(int position) {
		...
		ArrayList<Point> gameBoard = new ArrayList<>();
		gameBoard.add(new Point(30,288));
		gameBoard.add(new Point(30,548));
		gameBoard.add(new Point(288,548));
		gameBoard.add(new Point(548,548));
		gameBoard.add(new Point(548,288));
		gameBoard.add(new Point(548,30));
		gameBoard.add(new Point(288,30));
		gameBoard.add(new Point(30,30));
		gameBoard.add(new Point(116,288));
		gameBoard.add(new Point(116,462));
		gameBoard.add(new Point(288,462));
		gameBoard.add(new Point(462,462));
		gameBoard.add(new Point(462,288));
		gameBoard.add(new Point(462,116));
		gameBoard.add(new Point(288,116));
		gameBoard.add(new Point(116,116));
		
		result = gameBoard.get(position);
		return result;
		...
		if (row < 3) {
			...
			Point point = getPositionCoords(15 - position); //changed from 23
			point.x -= margin;
			point.y -= margin;
